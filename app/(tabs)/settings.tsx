...
export default function SettingsScreen() {
  const {
    colors, profile, latestMeasurement, themeMode, weightUnit, setThemeMode, setWeightUnit, catalogCount,
    syncCatalog, syncingCatalog, releaseInfo, checkingUpdate, downloadingUpdate, downloadedUpdateUri,
