...
export default function ExerciseDetailScreen() {
  ...
  const add = async () => { await addExercise(exercise); Alert.alert('Adicionado', `${exercise.name} entrou no treino atual.`, [{ text: 'Continuar' }, { text: 'Abrir treino', onPress: () => router.push('/workout/session') }]); };
  return <Screen>
    ...
    <Button title="Adicionar ao treino" onPress={add} />
